...
const studentDashboardNav: NavItem[] = [
  ...
  { href: '/app/bar-final-exams-nls-mcq', icon: ClipboardList, label: 'Bar Final Exam' },
...
const adminDashboardNav: NavItem[] = [
  ...
  { href: '/app/admin/bar-final-exams-nls-mcq', icon: ClipboardList, label: 'Bar Final Exam' },
